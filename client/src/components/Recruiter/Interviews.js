...
const Interviews = () => {
    ...
    // Filtering logic:new tab
    const filteredNewInterviews = newInterviewsData.filter(interview =>
        interview.jobTitle.toLowerCase().includes(searchTerm.toLowerCase())
    );

    // Filtering logic:pending tab
    const filteredPendingInterviews = pendingInterviewsData.filter(interview =>
        interview.jobTitle.toLowerCase().includes(searchTerm.toLowerCase())
    );

    // Filtering logic:scheduled tab
    const filteredScheduledInterviews = scheduledInterviewsData.filter(interview =>
        interview.jobTitle.toLowerCase().includes(searchTerm.toLowerCase())
    );

    // Filtering logic:completed tab
    const filteredCompltedInterviews = completedInterviewsData.filter(interview =>
        interview.jobTitle.toLowerCase().includes(searchTerm.toLowerCase())
    );
